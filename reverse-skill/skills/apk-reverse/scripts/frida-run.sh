...
if [[ "$LIST_DEVICES" == "true" ]]; then
    if command -v /Users/junwei/.local/share/python/cpython-3.12.13/bin/python3 >/dev/null 2>&1; then
        /Users/junwei/.local/share/python/cpython-3.12.13/bin/python3 -c "
import frida
